...
class EmulatorActions(_message.Message):
    ...
    class Instruction(_message.Message):
        __slots__ = ("opcode", "mem_access")
        OPCODE_FIELD_NUMBER: _ClassVar[int]
        MEM_ACCESS_FIELD_NUMBER: _ClassVar[int]
        opcode: bytes
        mem_access: EmulatorActions.MemoryAccess
        def __init__(self, opcode: _Optional[bytes] = ..., mem_access: _Optional[_Union[EmulatorActions.MemoryAccess, _Mapping]] = ...) -> None: ...
